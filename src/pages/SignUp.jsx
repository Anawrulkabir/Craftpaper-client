...
const SignUp = () => {
  const { createUser, signInWithGithub } = useContext(AuthContext)
  ...
  const handleSignUp = (e) => {
    ...
    console.log(name, email, password, checked, photoUrl)
  ...
  const handleGithubSignIn = () => {
    signInWithGithub()
      .then((result) => {
        ...
        toast.success('Successfully logged in with your github')
        setTimeout(() => {
    ...
    <div className="bg-gray-800 text-gray-800 w-full  flex justify-center items-center py-24   px-4 ">
      <div className="lg:w-1/3 md:w-1/2 w-full p-8 space-y-3 rounded-xl bg-gray-50 text-gray-800 lg:mt-10 ">
          ...
          <div className="space-y-1 text-sm">
            ...
            <div className="relative border rounded-md">
              <input
                ...
                className="w-full  px-4 py-3 rounded-md border-gray-700 dark:border-gray-300 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800 focus:border-indigo-400 focus:dark:border-indigo-600"
              />
              <div
                onClick={() => setShowPassword(!showPassword)}
                className="absolute cursor-pointer top-1/2 right-0 -translate-y-1/2 -translate-x-[60%] text-[18px]"
              >
        ...
        <div className="flex justify-center space-x-4">
          ...
          <button aria-label="Signup with Twitter" className="p-3 rounded-sm">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              className="w-5 h-5 fill-current"
